...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "fb3621f4f897824c0dbe0615fa94543df6192f30"
  WORKING_DIRECTORY "/Users/vaddikasulu/Thundersoft_work/Thundersoft/tflite_build/abseil-cpp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/vaddikasulu/Thundersoft_work/Thundersoft/tflite_build/abseil-cpp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/vaddikasulu/Thundersoft_work/Thundersoft/tflite_build/abseil-cpp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
